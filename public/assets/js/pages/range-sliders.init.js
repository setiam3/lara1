...
if (sliderColorScheme) sliderColorScheme.forEach(function (slider) {
...
if (multielementslider) multielementslider.forEach(function (slider) {
  noUiSlider.create(slider, {
    start: [20, 80],
    connect: true,
    range: {
...
var colors = [0, 0, 0];
if (sliders) [].slice.call(sliders).forEach(function (slider, index) {
  noUiSlider.create(slider, {
    start: 127,
    connect: [true, false],
...
if (pips) pips.forEach(function (ele) {
