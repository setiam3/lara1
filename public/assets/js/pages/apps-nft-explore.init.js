...
var allproductlist = ''; //mail list by json
...
function loadProductData(datas) {
  ...
  datas.forEach(function (prodctData, index) {
...
var filterDataAll = ''; // When the slider value changes, update the input and span
  ...
  if (loadmore) {
    ...
    loadmore.addEventListener("click", function (e) {
      ...
      if (elementList) {
        ...
        currentItems += 5; // Load more button will be hidden after list fully loaded
