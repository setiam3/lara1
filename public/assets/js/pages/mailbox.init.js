...
var allmaillist = '';
var loader = document.querySelector("#mailLoader"); // showing loading
//mail list by json
...
var dummyUserImage = "assets/images/users/user-dummy-img.jpg"; // email chat detail element
...
document.querySelectorAll(".email-chat-list a").forEach(function (item) {
  item.addEventListener("click", function (event) {
    ...
    mailChatDetailElm = true; // chat user list link active

    var chatUserList = document.querySelector(".email-chat-list a.active");
    if (chatUserList) chatUserList.classList.remove("active");
    this.classList.add("active");
    var currentChatId = "users-chat";
    scrollToBottom(currentChatId); //user Name and user Profile change on click
